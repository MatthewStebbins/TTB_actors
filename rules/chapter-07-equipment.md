...
This chapter covers the weapons, armor, and pneumatic limbs available in Malifaux.

- Most Earth equipment is also available in Malifaux, but **import fees** through the Breach are steep — often nearly as much as the item itself.
- The **Guild controls** passage of weapons through the Breach. Firearms and bladed weapons must either be imported with fees paid or smuggled through.
- Items purchased **in Malifaux** tend to be more expensive and limited in selection compared to Earth.

---

## Crafting Items

Each item has a **Skill value** indicating the minimum Crafting Skill rank required to create it. If the crafter's rank is lower, she cannot create the item.

**Raw materials cost:** one quarter (25%) of the item's listed price.

| Crafting Skill | Items Created |
|---|---|
| **Blacksmithing** | Most metal weapons and armor |
| **Artefacting** | Pneumatic weapons and prosthetics |
| **Homesteading** | Wooden weapons (clubs, staves), Skill Toolkits |
| **Stitching** | Cloth and leather armor; leather weapons (whips) |

---

## Skill Toolkits

Skill toolkits are collections of tools that aid characters in performing certain tasks. A character using a skill toolkit gains **+** to the relevant Skill Challenge duel. Each toolkit enhances only one specific Skill.

| Toolkit Type | Cost | Skill Req. | Contents (General) |
|---|---|---|---|
| Academic | 25§ | 4 | Notebooks, writing instruments, reference books, measuring devices |
| Crafting | 25§ | 4 | Small anvils, tables, kilns, or other large equipment (not easily mobile) |
| Expertise | 25§ | 4 | Compasses, maps, lenses, and specialized tools; fits in a small satchel |
| Magical | 50§ | 4 | Channeling crystals, focusing diagrams, etching chalk; **Guild monitors purchases** |
| Social | 25§ | 4 | Cosmetics, wigs, various perfumes |
| Training | 25§ | 4 | Back braces, morphine, cleated shoes, and varied skill-specific items |

---

## Weapon Special Rules Glossary

*(Entries added as new properties appear in weapon tables below.)*

| Property | Effect |
|---|---|
| **Choking** | See weapon description |
| **Concealable** | Can be hidden on the body |
| **Deadly** | See weapon description |
| **Finely Tuned** | See weapon description |
| **Slowing** | See weapon description |
| **Stunning** | See weapon description |
| **Tether** | See weapon description |

---

## Flexible Weapons

Flexible weapons use the **Flexible Combat Skill**.

| Weapon | Range | Damage | Special | Cost | Skill |
|---|---|---|---|---|---|
| Barbed Whip | y3 | 1/2/4 | Stunning | 15§ | 2 |
| Driving Whip | y2 | 1/2/3 | — | 2§ | 2 |
| Flail | y2 | 2/3/4 | — | 10§ | 2 |
| Garrote | y1 | 1/2/3 | Choking, Concealable, Deadly, Finely Tuned, Slowing | 1§ | 1 |
| Lasso | z6 | 1/1/2 | Finely Tuned, Deadly, Tether | 1§ | 1 |

### Weapon Descriptions

#### Barbed Whip
A whip with numerous small metal hooks or glass shards woven into its length, increasing damage to bare flesh. Thicker and heavier than a traditional whip — more painful but less flexible. Originally a human weapon later adopted by certain breeds of Nephilim.

#### Driving Whip
Typically found with coachmen, beastmasters, or Guild taskmasters. Features a handle, a semi-flexible shaft (2–3 feet), and a longer lash. Normally used to signal direction and pace; capable of opening painful welts when used as a weapon.

#### Flail
Originally a farming tool, now an uncommon weapon. Consists of one or more round or spiked metal heads attached to a short metal handle by chains. Not especially common in Malifaux or on Earth, but occasionally found in the hands of proficient users.

#### Garrote
An assassin's weapon for silent eliminations. A length of flexible but tough material (rope, cord, or piano wire) used to strangle a target from behind. Professional assassins often commission manufactured garrotes with custom handles.
